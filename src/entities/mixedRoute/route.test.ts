import { RBTC, Token, WRBTC, CurrencyAmount, Currency } from '@intrinsic-network/sdk-core'
...
describe('MixedRoute', () => {
  ...
  const token3 = new Token(30, '0x0000000000000000000000000000000000000004', 18, 't3')
  ...
  const pool_2_wrbtc = new Pool(token2, wrbtc, FeeAmount.MEDIUM, encodeSqrtRatioX96(1, 1), 0, 0, [])
  ...
  const pair_wrbtc_2 = new Pair(CurrencyAmount.fromRawAmount(wrbtc, '200'), CurrencyAmount.fromRawAmount(token2, '150'))
  ...
  describe('path', () => {
    ...
    it('wraps mixed route object and successfully constructs a path from the tokens', () => {
      const route = new MixedRouteSDK([pool_0_1, pair_1_wrbtc], token0, wrbtc)
      expect(route.pools).toEqual([pool_0_1, pair_1_wrbtc])
      expect(route.path).toEqual([token0, token1, wrbtc])
      expect(route.input).toEqual(token0)
    ...
    it('wraps complex mixed route object and successfully constructs a path from the tokens', () => {
      const route = new MixedRouteSDK([pool_0_1, pair_1_wrbtc, pair_wrbtc_2], token0, token2)
      expect(route.pools).toEqual([pool_0_1, pair_1_wrbtc, pair_wrbtc_2])
      expect(route.path).toEqual([token0, token1, wrbtc, token2])
      expect(route.input).toEqual(token0)
    ...
    it('wraps complex mixed route object with multihop V3 in the beginning and constructs a path', () => {
      const route = new MixedRouteSDK([pool_0_1, pool_1_wrbtc, pair_wrbtc_2], token0, token2)
      expect(route.pools).toEqual([pool_0_1, pool_1_wrbtc, pair_wrbtc_2])
      expect(route.path).toEqual([token0, token1, wrbtc, token2])
      expect(route.input).toEqual(token0)
      expect(route.output).toEqual(token2)
      expect(route.chainId).toEqual(30)
    ...
    it('wraps complex mixed route object with multihop V2 in the beginning and constructs a path', () => {
      const route = new MixedRouteSDK([pair_0_1, pair_1_wrbtc, pool_2_wrbtc], token0, token2)
      expect(route.pools).toEqual([pair_0_1, pair_1_wrbtc, pool_2_wrbtc])
      expect(route.path).toEqual([token0, token1, wrbtc, token2])
      expect(route.input).toEqual(token0)
      expect(route.output).toEqual(token2)
      expect(route.chainId).toEqual(30)
    ...
    it('wraps complex mixed route object with consecutive V3 in the middle and constructs a path', () => {
      const route = new MixedRouteSDK([pair_0_1, pool_1_wrbtc, pool_2_wrbtc, pair_2_3], token0, token3)
      expect(route.pools).toEqual([pair_0_1, pool_1_wrbtc, pool_2_wrbtc, pair_2_3])
      expect(route.path).toEqual([token0, token1, wrbtc, token2, token3])
      expect(route.input).toEqual(token0)
    ...
    it('wraps complex mixed route object with consecutive V2 in the middle and constructs a path', () => {
      const route = new MixedRouteSDK([pool_0_1, pair_1_wrbtc, pair_wrbtc_2, pool_2_3], token0, token3)
      expect(route.pools).toEqual([pool_0_1, pair_1_wrbtc, pair_wrbtc_2, pool_2_3])
      expect(route.path).toEqual([token0, token1, wrbtc, token2, token3])
      expect(route.input).toEqual(token0)
      expect(route.output).toEqual(token3)
      expect(route.chainId).toEqual(30)
  ...
  it('can have a token as both input and output', () => {
    const route = new MixedRouteSDK([pair_0_wrbtc, pair_0_1, pair_1_wrbtc], wrbtc, wrbtc)
    expect(route.pools).toEqual([pair_0_wrbtc, pair_0_1, pair_1_wrbtc])
  ...
  describe('#midPrice', () => {
    ...
    describe('100% V3 pool route', () => {
      ...
      it('correct for rbtc -> 0', () => {
        const routeV3SDK = new V3RouteSDK([pool_0_wrbtc], rbtc, token0)
        const route = new MixedRouteSDK([pool_0_wrbtc], rbtc, token0)
        expect(route.midPrice.toFixed(4)).toEqual(routeV3SDK.midPrice.toFixed(4))
        expect(route.midPrice.toFixed(4)).toEqual('0.3333')
        expect(route.midPrice.baseCurrency.equals(rbtc)).toEqual(true)
        expect(route.midPrice.quoteCurrency.equals(token0)).toEqual(true)
      })

      it('correct for 1 -> wrbtc', () => {
        const routeV3SDK = new V3RouteSDK([pool_1_wrbtc], token1, wrbtc)
        const route = new MixedRouteSDK([pool_1_wrbtc], token1, wrbtc)
        expect(route.midPrice.toFixed(4)).toEqual(routeV3SDK.midPrice.toFixed(4))
        expect(route.midPrice.toFixed(4)).toEqual('0.1429')
        expect(route.midPrice.baseCurrency.equals(token1)).toEqual(true)
        expect(route.midPrice.quoteCurrency.equals(wrbtc)).toEqual(true)
      })

      it('correct for rbtc -> 0 -> 1 -> wrbtc', () => {
        const routeV3SDK = new V3RouteSDK([pool_0_wrbtc, pool_0_1, pool_1_wrbtc], rbtc, wrbtc)
        const route = new MixedRouteSDK([pool_0_wrbtc, pool_0_1, pool_1_wrbtc], rbtc, wrbtc)
        expect(route.midPrice.toFixed(4)).toEqual(routeV3SDK.midPrice.toFixed(4))
      ...
      it('correct for wrbtc -> 0 -> 1 -> rbtc', () => {
        const routeV3SDK = new V3RouteSDK([pool_0_wrbtc, pool_0_1, pool_1_wrbtc], wrbtc, rbtc)
        const route = new MixedRouteSDK([pool_0_wrbtc, pool_0_1, pool_1_wrbtc], wrbtc, rbtc)
        expect(route.midPrice.toFixed(4)).toEqual(routeV3SDK.midPrice.toFixed(4))
        expect(route.midPrice.toSignificant(4)).toEqual('0.009524')
        expect(route.midPrice.baseCurrency.equals(wrbtc)).toEqual(true)
        expect(route.midPrice.quoteCurrency.equals(rbtc)).toEqual(true)
      })
    })
    ...
    describe('100% V2 pair route', () => {
      ...
      it('correct for rbtc -> 0', () => {
        const routeV2SDK = new V2RouteSDK([pair_0_wrbtc], rbtc, token0)
        const route = new MixedRouteSDK([pair_0_wrbtc], rbtc, token0)
        expect(routeV2SDK.midPrice.toFixed(4)).toEqual(route.midPrice.toFixed(4))
      ...
      it('correct for 1 -> wrbtc', () => {
        const routeV2SDK = new V2RouteSDK([pair_1_wrbtc], token1, wrbtc)
        const route = new MixedRouteSDK([pair_1_wrbtc], token1, wrbtc)
        expect(routeV2SDK.midPrice.toFixed(4)).toEqual(route.midPrice.toFixed(4))
      ...
      it('correct for rbtc -> 0 -> 1 -> wrbtc', () => {
        const routeV2SDK = new V2RouteSDK([pair_0_wrbtc, pair_0_1, pair_1_wrbtc], rbtc, wrbtc)
        const route = new MixedRouteSDK([pair_0_wrbtc, pair_0_1, pair_1_wrbtc], rbtc, wrbtc)
        expect(routeV2SDK.midPrice.toFixed(4)).toEqual(route.midPrice.toFixed(4))
      ...
      it('correct for wrbtc -> 0 -> 1 -> rbtc', () => {
        const routeV2SDK = new V2RouteSDK([pair_0_wrbtc, pair_0_1, pair_1_wrbtc], wrbtc, rbtc)
        const route = new MixedRouteSDK([pair_0_wrbtc, pair_0_1, pair_1_wrbtc], wrbtc, rbtc)
        expect(routeV2SDK.midPrice.toFixed(4)).toEqual(route.midPrice.toFixed(4))
        expect(route.midPrice.toSignificant(4)).toEqual('1.143')
        expect(route.midPrice.baseCurrency.equals(wrbtc)).toEqual(true)
        expect(route.midPrice.quoteCurrency.equals(rbtc)).toEqual(true)
    ...
    describe('mixed route', () => {
      ...
      it('correct for 0 -[V2]-> 1 -[V2]-> wrbtc -[V3]-> 2', () => {
        const route = new MixedRouteSDK([pair_0_1, pair_1_wrbtc, pool_2_wrbtc], token0, token2)
        /**
         * pair_0_1 midPrice = 200 / 100 = 2
         * nextInput = 1 -> pair_1_wrbtc midPrice = 100 / 175 = 0.5714
         * nextInput = wrbtc -> pool_2_wrbtc midPrice = is 1 -> 0 so 8/1 = 8
  ...
  describe('partitionMixedRouteByProtocol', () => {
    ...
    it('consecutive pair in middle of two pools', () => {
      ...
      const referenceSecondPart = [pair_1_wrbtc, pair_wrbtc_2]
    ...
    it('consecutive pair at the end', () => {
      const route: MixedRouteSDK<Currency, Currency> = new MixedRouteSDK(
        [pool_0_1, pair_1_wrbtc, pair_wrbtc_2, pair_2_3],
        token0,
        token3
      )
      const result = partitionMixedRouteByProtocol(route)
      ...
      expect(result[0][0]).toStrictEqual(pool_0_1)
      const referenceSecondPart = [pair_1_wrbtc, pair_wrbtc_2, pair_2_3]
    ...
    it('consecutive pair at the beginning', () => {
      const route: MixedRouteSDK<Currency, Currency> = new MixedRouteSDK(
        [pair_0_1, pair_1_wrbtc, pair_wrbtc_2, pool_2_3],
        token0,
        token3
      )
      const result = partitionMixedRouteByProtocol(route)
      expect(result.length).toEqual(2)
      const referenceFirstPart = [pair_0_1, pair_1_wrbtc, pair_wrbtc_2]
