...
describe('SwapRouter', () => {
  ...
  const pool_1_WRBTC = makePool(token1, wrbtc, liquidity)
  const pair_1_WRBTC = makePair(token1, wrbtc, liquidity)
  const pair_2_WRBTC = makePair(token2, wrbtc, liquidity)
  const pool_2_WRBTC = makePool(token2, wrbtc, liquidity)
  ...
  describe('#swapCallParameters', () => {
    ...
    describe('multi-hop exact input (v2 + v3)', () => {
      describe('different trade configurations result in identical calldata', () => {
        ...
        const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1, pair_1_WRBTC], token0, wrbtc), amountIn)
        const v3Trade = V3Trade.fromRoute(
          new V3Route([pool_0_1, pool_1_WRBTC], token0, wrbtc),
          amountIn,
          TradeType.EXACT_INPUT
        )
    ...
    describe('multi-hop exact output (v2 + v3)', () => {
      describe('different trade configurations result in identical calldata', () => {
        ...
        const amountOut = CurrencyAmount.fromRawAmount(wrbtc, JSBI.BigInt(100))

        const v2Trade = V2Trade.exactOut(new V2Route([pair_0_1, pair_1_WRBTC], token0, wrbtc), amountOut)
        const v3Trade = V3Trade.fromRoute(
          new V3Route([pool_0_1, pool_1_WRBTC], token0, wrbtc),
          amountOut,
          TradeType.EXACT_OUTPUT
    ...
    describe('Mixed Route', () => {
      ...
      describe('multi-hop exact input (mixed route) backwards compatible', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const mixedRouteTrade1 = MixedRouteTrade.fromRoute(
            new MixedRouteSDK([pair_0_1, pair_1_WRBTC], token0, wrbtc),
            amountIn,
            TradeType.EXACT_INPUT
          )
          const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
            new MixedRouteSDK([pool_0_1, pool_1_WRBTC], token0, wrbtc),
            amountIn,
            TradeType.EXACT_INPUT
          )
      ...
      describe('mixed route trades with routes with consecutive pools/pairs', () => {
        ...
        const amountIn = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))
        const mixedRouteTrade1 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pool_0_1, pool_1_WRBTC, pair_2_WRBTC], token0, wrbtc),
          amountIn,
          TradeType.EXACT_INPUT
        )
        const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pair_0_1, pair_1_2, pool_2_WRBTC], token0, wrbtc),
          amountIn,
          TradeType.EXACT_INPUT
        )
    ...
    describe('RBTC input', () => {
      describe('single-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const amountIn = CurrencyAmount.fromRawAmount(rbtc, JSBI.BigInt(100))

          const v2Trade = V2Trade.exactIn(new V2Route([pair_1_WRBTC], rbtc, token1), amountIn)
          const v3Trade = V3Trade.fromRoute(new V3Route([pool_1_WRBTC], rbtc, token1), amountIn, TradeType.EXACT_INPUT)
          /// mixedRouteTrade mirrors the V3Trade
          const mixedRouteTrade = MixedRouteTrade.fromRoute(
            new MixedRouteSDK([pool_1_WRBTC], rbtc, token1),
            amountIn,
            TradeType.EXACT_INPUT
          )
      ...
      describe('single-hop exact output (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          const expectedCalldata =
            ''
          const amountOut = CurrencyAmount.fromRawAmount(token1, JSBI.BigInt(100))

          const v2Trade = V2Trade.exactOut(new V2Route([pair_1_WRBTC], rbtc, token1), amountOut)
          const v3Trade = V3Trade.fromRoute(
            new V3Route([pool_1_WRBTC], rbtc, token1),
            amountOut,
            TradeType.EXACT_OUTPUT
          )
      ...
      describe('multi-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.exactIn(new V2Route([pair_1_WRBTC, pair_0_1], rbtc, token0), amountIn)
          /// mixedRouteTrade mirrors V2Trade
          const mixedRouteTrade = MixedRouteTrade.fromRoute(
            new MixedRouteSDK([pair_1_WRBTC, pair_0_1], rbtc, token0),
            amountIn,
            TradeType.EXACT_INPUT
          )
          const v3Trade = V3Trade.fromRoute(
            new V3Route([pool_1_WRBTC, pool_0_1], rbtc, token0),
            amountIn,
            TradeType.EXACT_INPUT
          )
      ...
      describe('multi-hop exact output (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          const expectedCalldata =
            ''
          const amountOut = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))

          const v2Trade = V2Trade.exactOut(new V2Route([pair_1_WRBTC, pair_0_1], rbtc, token0), amountOut)
          const v3Trade = V3Trade.fromRoute(
            new V3Route([pool_1_WRBTC, pool_0_1], rbtc, token0),
            amountOut,
            TradeType.EXACT_OUTPUT
      ...
      describe('high price impact with RBTC input to result in refundRBTC being appended to calldata', () => {
        const expectedCalldata =
          ''
        const amountIn = CurrencyAmount.fromRawAmount(rbtc, JSBI.BigInt(100))
        const pool_1_WRBTC_slippage = makePool(token1, wrbtc, 100)
        const REFUND_RBTC_FUNCTION_SIG = /492a5459/

        const v2Trade = V2Trade.exactIn(new V2Route([pair_1_WRBTC], rbtc, token1), amountIn)
        const v3Trade = V3Trade.fromRoute(
          new V3Route([pool_1_WRBTC_slippage], rbtc, token1),
          amountIn,
          TradeType.EXACT_INPUT
        )
        ...
        it('array of trades', async () => {
          ...
          expect(calldata).toEqual(expectedCalldata)
          expect(calldata).toMatch(REFUND_RBTC_FUNCTION_SIG)
          expect(value).toBe('0xc8')
        })
      })

      describe('high price impact with ERCO20 input does not result in refundRBTC call', () => {
        const expectedCalldata =
        ...
        const v2Trade = V2Trade.exactIn(new V2Route([pair_1_WRBTC], token1, wrbtc), amountIn)
        const v3Trade = V3Trade.fromRoute(
          new V3Route([pool_1_WRBTC_slippage], token1, wrbtc),
          amountIn,
          TradeType.EXACT_INPUT
        )
        ...
        it('array of trades', async () => {
          ...
          expect(calldata).toEqual(expectedCalldata)
          expect(calldata).not.toMatch(REFUND_RBTC_FUNCTION_SIG)
          expect(value).toBe('0x00')
        })
      })
    })
    ...
    describe('RBTC output', () => {
      describe('single-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          const expectedCalldata =
            ''
          const amountIn = CurrencyAmount.fromRawAmount(token1, JSBI.BigInt(100))

          const v2Trade = V2Trade.exactIn(new V2Route([pair_1_WRBTC], token1, rbtc), amountIn)
          const v3Trade = V3Trade.fromRoute(new V3Route([pool_1_WRBTC], token1, rbtc), amountIn, TradeType.EXACT_INPUT)
          /// mixedRoute mirrors v3Trade
          const mixedRouteTrade = MixedRouteTrade.fromRoute(
            new MixedRouteSDK([pool_1_WRBTC], token1, rbtc),
            amountIn,
            TradeType.EXACT_INPUT
          )
      ...
      describe('single-hop exact output (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          const expectedCalldata =
            ''
          const amountOut = CurrencyAmount.fromRawAmount(rbtc, JSBI.BigInt(100))

          const v2Trade = V2Trade.exactOut(new V2Route([pair_1_WRBTC], token1, rbtc), amountOut)
          const v3Trade = V3Trade.fromRoute(
            new V3Route([pool_1_WRBTC], token1, rbtc),
            amountOut,
            TradeType.EXACT_OUTPUT
          )
      ...
      describe('multi-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          const expectedCalldata =
            ''
          const amountIn = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))

          const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1, pair_1_WRBTC], token0, rbtc), amountIn)
          /// mixedRouteTrade mirrors v2Trade
          const mixedRouteTrade = MixedRouteTrade.fromRoute(
            new MixedRouteSDK([pair_0_1, pair_1_WRBTC], token0, rbtc),
            amountIn,
            TradeType.EXACT_INPUT
          )
          const v3Trade = V3Trade.fromRoute(
            new V3Route([pool_0_1, pool_1_WRBTC], token0, rbtc),
            amountIn,
            TradeType.EXACT_INPUT
          )
          ...
          it('meta-trade with mixedRoute produces same calldata but in different order', async () => {
            const expectedCalldata =
              ''
            const trades = await Trade.fromRoutes(
              [],
              [
                {
      ...
      describe('multi-hop exact output (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          const expectedCalldata =
            ''
          const amountOut = CurrencyAmount.fromRawAmount(rbtc, JSBI.BigInt(100))

          const v2Trade = V2Trade.exactOut(new V2Route([pair_0_1, pair_1_WRBTC], token0, rbtc), amountOut)
          const v3Trade = V3Trade.fromRoute(
            new V3Route([pool_0_1, pool_1_WRBTC], token0, rbtc),
            amountOut,
            TradeType.EXACT_OUTPUT
    ...
    describe('#swapAndAddCallParameters', () => {
      ...
      describe('multi-hop trades', () => {
        ...
        const pool_0_WRBTC = makePool(token0, wrbtc, liquidity)
        const amountIn = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))
        const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1, pair_1_WRBTC], token0, wrbtc), amountIn)
        /// mirrors V2Trade
        const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
      ...
      describe('when input is native', () => {
        const expectedCalldata =
          ''

        const rbtc = RBTC.onChain(30)
        const amountIn = CurrencyAmount.fromRawAmount(rbtc, JSBI.BigInt(10))
        const v3Trade = V3Trade.fromRoute(new V3Route([pool_1_WRBTC], rbtc, token1), amountIn, TradeType.EXACT_INPUT)
        const mixedRouteTrade3 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pool_1_WRBTC], rbtc, token1),
          amountIn,
      ...
      describe('when output is native', () => {
        const expectedCalldata =
          ''
        const rbtc = RBTC.onChain(30)
